...
const Skills = () => {
  return (
    <section id='skills'>
        ...
        <span className='skillDescr'>I'm a skilled and passionate web designer in creating visually appealing and user friendly web pages . I have a strong understanding of design and a keen eye for design .</span>
